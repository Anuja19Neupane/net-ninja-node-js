...
//connect to mongodb
const dbURI = 'mongodb+srv://dbanuja:anuja%40123@atlascluster.lq08dxc.mongodb.net/node-tutorial'
...
app.get('/blogs/:id',(req, res) => { // :id is route parameter, it's like variable which can be replaced
